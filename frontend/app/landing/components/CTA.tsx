...
import { ArrowRight, Users, Clock, CheckCircle, Shield } from "lucide-react";
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          <Button 
            variant="default" 
            size="lg" 
            className="rounded-lg text-base px-10 py-4 font-black bg-orange-500 hover:bg-orange-400 hover:shadow-[0_0_40px_-10px_#CF4500] transition-all" 
            asChild
          >
            <Link href="/login">
              Start Building Free
        ...
        {/* Featured user logos */}
        <div className="mt-16">
          <p className="text-xs font-medium tracking-wider text-muted-foreground mb-6">TRUSTED BY ENGINEERS AT</p>
